...
const SECTIONS: PolicySection[] = [
  {
    ...
    content: (
      <>
        <P>
          By accessing or using any ACorp product or website (collectively, the
          "Services"), you agree to be bound by these Terms of Service ("Terms")
          and our{" "}
          <InternalLink to="/privacy">Privacy Policy</InternalLink>. If you do
          not agree to these Terms, do not use the Services.
        </P>
        <P>
          These Terms constitute a legally binding agreement between you (or the
          organization you represent) and ACorp, Inc., a Delaware corporation
          ("ACorp," "we," "our," or "us"). If you are accepting these Terms on
  ...
  },
  {
    ...
    content: (
      <>
        <P>
          ACorp provides a suite of web-based software applications, including
          Invoice, Zendo, and OpenComms, as well as the acorp.dev marketing
          website and any future products or features we make available
          (collectively, the "Services"). We reserve the right to modify,
          suspend, or discontinue any part of the Services at any time with
          reasonable notice where practicable.
        </P>
        <P>
          Features and functionality of individual products are described in
          their respective product documentation, which is incorporated into
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <P>
          To access most features of the Services, you must create an account.
        ...
        <P>
          ...
          <A href="mailto:legal@acorp.dev">legal@acorp.dev</A> if you suspect
          unauthorized access to your account. We are not liable for any loss
          resulting from unauthorized use of your account.
        </P>

        <H3>3.4 One Account Per User</H3>
        <P>
          Each account is for a single user unless you have subscribed to a
          plan that explicitly includes team or multi-seat access. You may not
    ...
    content: (
      <>
        ...
        <Ul>
          ...
          <li>
            Transmit harmful, offensive, defamatory, fraudulent, or deceptive
            content
          </li>
          <li>
            Distribute malware, viruses, or other malicious code or interfere
          ...
          <li>
            Resell, sublicense, or otherwise commercialize the Services without
            authorization
          </li>
          <li>
          ...
          <li>
            Use the Services in any manner that could overburden or impair our
            infrastructure
          </li>
        </Ul>
        <P>
          We reserve the right to investigate and, where appropriate, suspend or
          terminate accounts found to be in violation of these provisions.
        </P>
      </>
    ),
  },
    ...
    content: (
      <>
        ...
        <P>
          ...
          and other content, are owned by or licensed to ACorp and are protected
          by copyright, trademark, and other intellectual property laws. Nothing
          in these Terms grants you any ownership interest in the Services.
        </P>
        ...
        <P>
          ...
          the Services for your internal business or personal purposes.
        </P>

        <H3>5.3 Your Content</H3>
        <P>
          You retain ownership of any data, files, or content you upload to the
          Services ("Your Content"). By uploading Your Content, you grant us a
          limited, worldwide license to store, display, and process it solely as
          necessary to provide the Services to you. We do not claim ownership of
          Your Content and will not use it for any other purpose.
        </P>

        <H3>5.4 Feedback</H3>
        <P>
          If you submit ideas, suggestions, or feedback about the Services, you
    ...
    content: (
      <>
        ...
        <P>
          ...
          your payment method on a recurring basis at the then-current rate for
          your selected plan.
        </P>
        ...
        <P>
          ...
          depending on the plan you select. All fees are in US dollars unless
          otherwise stated and are non-refundable except as required by
          applicable law or as explicitly stated in our refund policy.
        </P>

        <H3>6.3 Price Changes</H3>
        <P>
          We may change subscription prices with at least 30 days' notice. Your
        ...
        <P>
          We may offer free trial periods for paid features. At the end of a
          free trial, your account will automatically convert to a paid
        ...
        <P>
          ...
          any sales, use, value-added, or similar taxes imposed by any
    ...
    content: (
      <>
        ...
        <P>
          ...
          requirements, that they will be available at all times without
          interruption, or that any errors or defects will be corrected. We
    ...
    content: (
      <>
        <P>
          ...
          ACORP, ITS AFFILIATES, DIRECTORS, EMPLOYEES, OR LICENSORS BE LIABLE
          FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE
          DAMAGES — INCLUDING LOSS OF PROFITS, DATA, GOODWILL, OR BUSINESS
          INTERRUPTION — ARISING FROM OR RELATED TO YOUR USE OF OR INABILITY TO
        ...
        <P>
          ...
          (A) THE AMOUNTS YOU PAID TO US IN THE TWELVE (12) MONTHS PRECEDING THE
          CLAIM OR (B) ONE HUNDRED US DOLLARS ($100).
        </P>
        <P>
          Some jurisdictions do not allow the exclusion or limitation of certain
          warranties or liabilities. In such jurisdictions, our liability will be
  ...
  },
  {
    ...
    content: (
      <>
        <P>
          You agree to defend, indemnify, and hold harmless ACorp and its
          ...
          or relating to: (a) your violation of these Terms; (b) your use of the
          Services; (c) Your Content; or (d) your violation of any law or the
    ...
    content: (
      <>
        ...
        <P>
          ...
          Upon cancellation, your access to paid features will continue until the
        ...
        <P>
          ...
          with or without cause and with or without notice, if we believe you
          have violated these Terms or if required by law. We will make
          reasonable efforts to provide notice where practicable.
        </P>
    ...
    content: (
      <>
        ...
        <P>
          ...
          <A href="mailto:legal@acorp.dev">legal@acorp.dev</A> and attempt to
          resolve the dispute informally for at least 30 days.
        </P>

        <H3>11.3 Binding Arbitration</H3>
        <P>
          If informal resolution fails, any dispute arising from or relating to
          these Terms or the Services will be resolved by binding arbitration
          administered by JAMS under its then-current rules, rather than in
          court, except that either party may seek injunctive or other equitable
          relief in a court of competent jurisdiction for claims involving
          intellectual property or unauthorized access to the Services.
        </P>

        <H3>11.4 Class Action Waiver</H3>
        <P>
          You agree to resolve disputes with us on an individual basis only. You
          may not bring or participate in any class or representative action
          against ACorp.
        </P>
      </>
    ),
    ...
    content: (
      <>
        <P>
          ...
          where required by law or where reasonably practicable, notify you by
          email or via a prominent notice in the Services.
        </P>
        <P>
          Your continued use of the Services after the effective date of any
          changes constitutes your acceptance of the revised Terms. If you do not
          agree to the revised Terms, you must stop using the Services.
        </P>
      </>
    ),
  },
    ...
    content: (
      <>
        ...
        <Ul>
          <li>
            <strong>Email:</strong>{" "}
            <A href="mailto:legal@acorp.dev">legal@acorp.dev</A>
          </li>
          <li>
...
function InternalLink({
  ...
  to: "/privacy" | "/terms" | "/products" | "/custom" | "/";
