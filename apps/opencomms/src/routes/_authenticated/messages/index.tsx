...
const CONVERSATIONS = [
  {
    id: "1",
    name: "Maria Gonzalez",
    preview: "Thanks! I'll be there at 6pm.",
    channel: "wa",
    time: "3h ago",
    unread: true,
  },
  {
    id: "2",
    name: "David Park",
    preview: "Can I reschedule for next week?",
    channel: "sms",
    time: "5h ago",
    unread: true,
  },
  {
    id: "3",
    name: "Priya Nair",
    preview: "Got it, thank you so much!",
    channel: "wa",
    time: "Yesterday",
    unread: false,
  },
  ...
  { id: "7", name: "Yuki Tanaka", preview: "Confirmed!", channel: "wa", time: "Sun", unread: false },
  {
    id: "8",
    name: "Sofia Andersen",
    preview: "Can you send me the details?",
    channel: "sms",
    time: "Sat",
    unread: false,
  },
...
function MessagesLayout() {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      >
        <div>
          <p className="text-xs font-bold tracking-[0.22em] uppercase" style={{ color: "#7F8CAA" }}>
            Inbox
          </p>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="flex w-72 flex-shrink-0 flex-col bg-white" style={{ borderRight: "1px solid #7F8CAA18" }}>
          {/* Search */}
          <div className="p-3" style={{ borderBottom: "1px solid #7F8CAA12" }}>
              ...
              return (
                ...
                >
                  <Avatar className="mt-0.5 size-9 flex-shrink-0">
                    <AvatarFallback className="text-white text-xs font-bold" style={{ backgroundColor: "#4382df" }}>
                      {initials(c.name)}
                    </AvatarFallback>
                  </Avatar>
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center justify-between gap-1 mb-0.5">
                      ...
                      <span className="flex-shrink-0 text-[10px]" style={{ color: "#7F8CAA" }}>
                        {c.time}
                      </span>
                    </div>
                    <div className="flex items-center justify-between gap-1">
                      <span className="text-[11px] truncate" style={{ color: "#7F8CAA" }}>
                        {c.preview}
                      </span>
